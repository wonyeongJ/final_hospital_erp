...
<div id="schedule-insert-all-component">
    ...
    <div class="clearfix mb-20">
        <div id="schedule-update-btn">
            <input type="button" class="btn btn-outline-primary" value="수술실 예약 변경"></button>
        </div>
    </div>
        <br>
</div>

<script src="/vendors/scripts/surgery/scheduleUpdate.js"></script>