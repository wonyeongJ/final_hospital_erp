<%@ page language="java" contentType="text/html; charset=utf-8"
    pageEncoding="utf-8"%>
<link rel="stylesheet" href="/vendors/styles/surgery/reservation.css">
...
<div class="form-group row">
    <label for="example-datetime-local-input" class="col-sm-12 col-md-2 col-form-label" style="font-weight: bold;">조회 날짜</label>
...
<table class="time-table-1">
    ...
    <br>
<span class="green-dot">●</span><span> : 예약 가능</span>
    <br>
<span class="red-dot">●</span><span> : 예약 불가</span>
    <br><br><br><br>
<div class="form-group row">
    <label class="col-sm-12 col-md-2 col-form-label" style="font-weight: bold;">시작 시간</label>
    <div class="col-sm-12 col-md-10">
...
<div class="form-group row">
    <label class="col-sm-12 col-md-2 col-form-label" style="font-weight: bold;">종료 시간</label>
    <div class="col-sm-12 col-md-10">
        <select class="custom-select col-12">
...
<div class="clearfix mb-20">
    <div class="pull-right">
        <input type="button" id="" class="btn btn-outline-primary header-white" value="수술실 예약"></button>
    </div>
</div>
    <br>