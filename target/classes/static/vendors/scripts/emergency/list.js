    ...
    $(document).on('click', '#openMap', function(e) {
        ...
        */
        var mapContainer = document.getElementById('map'), // 지도를 표시할 div
            mapOption = {
                center: new kakao.maps.LatLng(37.4764440, 126.8797607), // 지도의 중심좌표
                level: 9 // 지도의 확대 레벨
            };
        ...
        // 마커가 표시될 위치입니다
        var markerPosition  = new kakao.maps.LatLng(37.4764440, 126.8797607);
        ...
        var infowindow = new kakao.maps.InfoWindow({
            content: "<div style='width:150px;text-align:center;padding:6px 0;'>구디병원</div>"
        });
        ...
        geocoder.addressSearch(ad, function(result, status) {
            ...
            // 정상적으로 검색이 완료됐으면
             if (status === kakao.maps.services.Status.OK) {
                ...
                // 인포윈도우로 장소에 대한 설명을 표시합니다
                var infowindow = new kakao.maps.InfoWindow({
                    content: "<div style='width:150px;text-align:center;padding:6px 0;'>" + nm + "<br/>(" + tel + ")</div>"
                });
                infowindow.open(map, marker);
